...
public class TestSuite {
    ...
    @Test(priority = 8 , description = "Verify that all the users get fetched")
    public void GetUser_1(){
        Assert.assertEquals(get.getallUsers(),200);
    }
//    @Test(priority = 9 , description = "Verify that the user should not get fetched using Invalid UserId")
//    public void GetUser_2(){
//        Assert.assertEquals(get.getUserTest("324556"),422);
//    }
